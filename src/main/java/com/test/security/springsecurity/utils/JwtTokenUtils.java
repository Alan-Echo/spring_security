...
public class JwtTokenUtils {
    ...
    public static String generateJsonWebToken(SysUserEntity user) {

        if (user.getId() == null || user.getAccount() == null || user.getUser_name() == null) {
            return null;
        }
